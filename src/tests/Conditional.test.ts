...
describe('Generate Truthy Condition', () => {
  ...
  it('Should have the correct static properties ', () => {
    expect(condition.generableType).toBe(CircleCI.mapping.GenerableEnum.TRUTHY);
  });
});
...
describe('Generate basic conditionals', () => {
  it('true or false should be true', () => {
    ...
    expect(condition.generableType).toBe(GenerableEnum.OR);
  ...
  it('A number should be equal to itself as a string', () => {
    ...
    expect(condition.generableType).toBe(GenerableEnum.EQUAL);
    expect(condition.evaluate()).toBeTruthy();
  });
  ...
  it('Same booleans should be equal', () => {
    ...
    expect(condition.generableType).toBe(GenerableEnum.AND);
    expect(condition.evaluate()).toBeTruthy();
  });
  ...
  it('False notted should be true', () => {
    ...
    expect(condition.generableType).toBe(GenerableEnum.NOT);
    expect(condition.evaluate()).toBeTruthy();
  });
